...
int main()
{
   ...
   HourlyWorker hourlyemployee(
	   "Karen", "Price", "222-22-2222", 16.75, 40.00);
   CommissionEmployee commissionEmployee( 
      "Sue", "Jones", "333-33-3333", 10000, .06 );
   BasePlusCommissionEmployee basePlusCommissionEmployee( 
      "Bob", "Lewis", "444-44-4444", 5000, .04, 300 );
   PieceWorker pieceemployee(
	   "Justin", "Grenn", "555-565-5555", 22.50, 30);
   ...
   // initialize vector with base-class pointers aiming at derived-class objects
   ...
   //for ( const Employee *employeePtr : employees ) // range base for loop
